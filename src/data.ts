...
export const subjectsInfo: Record<string, string> = {
    ...
    VLSI: `
        ...
        الدكتور محمد عبد المجيد بدخل في دوائر الـ MOSFET وتحليلها، وبعد ذلك بنتقل لموضوع تصميم الـ Logic Gates. أما الدكتور هاني، فبيبدأ بمراجعة سريعه للـ MOSFET وللـ BJT وبشرح التصاميم القديمة المعتمدة على الـ BJT، وبعدها بشرح التصاميم الحديثة باستخدام الـ MOSFET. 

        يفضل لو تعمل مراجعه سريعه لمادة الفاينل من الكترونيات 1 قبل ما تنزل الماده
...
فيديوهات بتغطي الموضوع الي بشرحه الدكتور هاني قبل الدخول بال MOSFET:
    ...
    "CE Prob": `
        (الي كتب المقال المهندس محمد ضيف الله الشبيكات)
