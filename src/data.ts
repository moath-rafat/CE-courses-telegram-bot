export const subjectsInfo: Record<string, string> = {
    ...
    SUB_Organization1: `
        ...
        ⁃ بعدين بتتناول مواضيع سِهلة بتتعلّق بالعمليّات الحسابيّة البسيطة، بعديها بتتناول مواضيع خاصّة بال Hardware.

        ⁃ بعدها بتيجي مواضيع متقدّمة بالperformance لتصير الأجهرة أسرع زي ال pipelining وال parallelism وآخر إشي بنتحدّث عن أنواع الميموريز.
    ...
    SUB_Embedded: `
        ...
        ❓كيف ادرس واجيب A
        ضروري نكتب مع الدكتور كل كلمة بيحكيها ونتبّع أول بأول معه ونفهم الAssembly والبرامج كيف ماشية وما نستتفه التسلسل الّي ماشي فيه الدكتور والتدريج ونحلّ التمارين الّي بينشزهم تيمز "عن فهم " ونطبق بإيدنا ع الماتلاب أول بأول وندقق بكل التفاصيل الّي بيحكيها الدكتور
    ...
    SUB_Python_lab: `
        ...
        - اللاب بتكون من 10 تجارب بحيث انه:
        * أول 4 أسابيع:
        • أساسيات البايثون، زي المتغيرات، جمل الشرط (if)، الحلقات (loops)، القوائم (Lists) وكل الأوامر اللي لازم تكون عارفهاو كيف تقرأ الملفات وتعدل عليها وتحفظها .
        ...
        * الأسبوع 8:
        • مكتبة Tkinter، واللي بتخليك تصمم واجهات رسومية (GUI) لبرامجك عشان يكون استخدامها أسهل
